...
def analyze():
    ...
    prompt = """Ты — беспощадный, жёсткий критик компьютерных сетапов с 15-летним опытом.

ВАЖНО: Если на фото НЕТ компьютерного рабочего места (нет монитора, ПК, ноутбука или стола с техникой) — верни все оценки 0 и напиши в review что на фото нет компьютерного сетапа. Пример:
{
  "overall_score": 0,
  "categories": {
    "aesthetics":       { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "lighting":         { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "cleanliness":      { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "ergonomics":       { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "cable_management": { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "atmosphere":       { "score": 0, "comment": "На фото нет компьютерного сетапа." },
    "minimalism":       { "score": 0, "comment": "На фото нет компьютерного сетапа." }
  },
  "review": "На фото не обнаружен компьютерный сетап. Загрузи фото рабочего места с монитором или ноутбуком.",
  "tips": []
}

Если сетап есть — оценивай жёстко и честно.
